...
- MANA-024 Auditoría operativa de Cumbre Mundial 2026
  ...
  - Status: Exportes, Centro de Soluciones, notificaciones y corrección con vista previa auditados. Se reforzaron secretos de exportación, webhooks idempotentes y la operación manual: identidad individual, límites de saldo/moneda y conciliación que no invita a reenviar un pago ya escrito. Los crons de cobro/recordatorio siguen desactivados hasta definir si Cumbre está activa, en cierre o archivada. Pendientes: ejecutar el índice único de pagos, hacer una prueba controlada y diseñar una función transaccional para pago, plan y donación.
