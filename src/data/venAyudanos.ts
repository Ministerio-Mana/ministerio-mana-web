...
export const ministries: Record<MinistryKey, MinistryConfig> = {
  ...
  mujeres: {
    ...
    headline: 'Pilares de una casa viva',
    subheadline: 'Mujeres afirmadas en Cristo, formadas en la Palabra y listas para edificar.',
    body: 'Creemos en mujeres que no solo sostienen estructuras, sino que levantan a otras con gracia, sabiduría y propósito. Hay espacio para acompañar, crear recursos, servir y abrir caminos de formación.',
    cta: 'Quiero ayudar en Mujeres',
    href: '/ven-ayudanos/mujeres',
    accent: '#F6519B',
    glow: 'rgba(246, 81, 155, 0.23)',
  ...
  ninos: {
    ...
    headline: 'Siembra en la próxima generación',
    subheadline: 'Sirve, enseña, crea recursos y ayuda a que los niños conozcan a Jesús.',
    body: 'Cada niño necesita crecer en la Palabra y ser acompañado con amor. La ayuda puede verse como enseñanza, apoyo a materiales, acompañamiento a familias, eventos, campañas y oración.',
    cta: 'Quiero ayudar en Niños',
    href: '/ven-ayudanos/ninos',
    accent: '#A855F7',
    glow: 'rgba(168, 85, 247, 0.23)',
    actions: ['Enseñar', 'Servir como auxiliar', 'Crear recursos bíblicos', 'Acompañar familias'],
    pillars: [
