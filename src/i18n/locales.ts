...
export const messages: Record<Locale, Record<string,string>> = {
  es: {
    ...
    footer_player_source: 'Audio vía Spotify',
    footer_player_title_fallback: 'Devocional Maná',
    footer_playlist_label: 'Devocionales',
    footer_player_iframe_title: 'Devocional Maná en Spotify',
    footer_player_body_fallback: 'Reproduce el devocional en Spotify y continúa navegando por el sitio.',
    footer_player_play: 'Abrir Spotify',
  ...
  en: {
    ...
    footer_player_source: 'Audio via Spotify',
    footer_player_title_fallback: 'Maná Devotional',
    footer_playlist_label: 'Devotionals',
    footer_player_iframe_title: 'Maná Devotional on Spotify',
    footer_player_body_fallback: 'Play the devotional on Spotify and keep browsing the site.',
    footer_player_play: 'Open Spotify',
