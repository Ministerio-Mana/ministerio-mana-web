...
export const messages: Record<Locale, Record<string,string>> = {
  es: {
    ...
    footer_devotional_text: 'Palabra diaria para volver a Dios durante el día.',
    ...
    footer_player_source: 'Devocional en YouTube',
    footer_player_title_fallback: 'Devocional Maná',
    footer_playlist_label: 'Devocionales',
    footer_player_iframe_title: 'Devocional Maná en YouTube',
    footer_player_body_fallback: 'Abre el devocional más reciente con la miniatura oficial de YouTube.',
    footer_player_play: 'Reproducir',
    footer_player_progress: 'Progreso del devocional',
    footer_player_latest: 'Último',
  ...
  en: {
    ...
    footer_devotional_solid: 'Maná',
    footer_devotional_text: 'A daily word to return to God throughout the day.',
    footer_join: 'Receive on WhatsApp',
    footer_youtube_channel: 'View YouTube channel',
    footer_player_aria: 'Maná Devotional player',
    footer_player_source: 'Devotional on YouTube',
    footer_player_title_fallback: 'Maná Devotional',
    footer_playlist_label: 'Devotionals',
    footer_player_iframe_title: 'Maná Devotional on YouTube',
    footer_player_body_fallback: 'Open the latest devotional with the official YouTube thumbnail.',
    footer_player_play: 'Play',
    footer_player_progress: 'Devotional playback progress',
    footer_player_latest: 'Latest',
